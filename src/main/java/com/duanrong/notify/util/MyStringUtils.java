...
public class MyStringUtils extends StringUtils {
     ...
     * @return
     */
    public static boolean mailchick(String mail) {
     ...
     *
     * @param String
     * @return 手机号正则表达式 ^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$
     */
    public static boolean phoneChick(String phone) {
